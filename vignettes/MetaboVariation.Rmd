...
The objective of the __MetaboVariation__ package is to faciliate implementation of a a methodology for identifying individuals with significant
...
After fitting the BGLM, the function `plot` visualizes the results. The function can show the results in two formats i.e. a circos plot, and the number of flagged individuals per time point for each metabolite. 
