...
#' @description
#' A function to list the flagged individuals resulting from fitting a Bayesian generalised linear model (BGLM) model to repeated measures metabolomic data.
#'
